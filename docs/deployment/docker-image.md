...
docker pull ghcr.io/corebunch/instatic:0.0.21
```

The v0.0.21 published image is built for `linux/amd64`. Use it on Railway and x86_64 VPS/container hosts. ARM64 hosts should build from source for now, or wait for the native arm64 release job before pulling GHCR images directly.
...
```txt
ghcr.io/corebunch/instatic:0.0.21
```
